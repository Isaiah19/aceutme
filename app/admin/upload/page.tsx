...
export default function AdminUploadPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Admin gate: middleware should already redirect, but this is a safety check
      // If middleware didn't run, user might still land here; we rely on cookie.
      // (No extra client check needed.)
